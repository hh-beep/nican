  ...
  return (
    <section className="Inicio">
      ...
      <p className='Inicio_Text'>
        O Grupo Escoteiro Católico Nican Mopohua – 222/PR surgiu em 2016 com o propósito de oferecer à juventude um movimento educacional sem fins lucrativos que promove o desenvolvimento integral de crianças, adolescentes e jovens — unindo o método escoteiro aos valores cristãos da fé católica.
